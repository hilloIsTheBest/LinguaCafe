...
// OIDC routes (enabled via config/oidc.php)
Route::group(['middleware' => ['web']], function () {
    Route::get('/auth/oidc', [App\Http\Controllers\Auth\OidcController::class, 'redirect'])->name('oidc.login');
...
Route::group(['middleware' => ['auth', 'auth.session', 'web']], function () {
    ...
    Route::post('/vocabulary/import-from-anki-apkg', [App\Http\Controllers\VocabularyController::class, 'importFromAnkiApkg']);
    ...
    // social
    Route::get('/social/stats', [App\Http\Controllers\SocialController::class, 'getStats']);
    Route::get('/social/shop', [App\Http\Controllers\SocialController::class, 'getShop']);
    Route::post('/social/purchase', [App\Http\Controllers\SocialController::class, 'purchase']);
    Route::get('/social/leaderboard', [App\Http\Controllers\SocialController::class, 'leaderboard']);
    ...
    Route::get('/reviews/games', [App\Http\Controllers\ReviewController::class, 'getGameItems']);
    ...
    Route::post('/public/books/copy/{bookId}', [App\Http\Controllers\PublicLibraryController::class, 'copyPublicBook']);
