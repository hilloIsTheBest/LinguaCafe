        ...
        <v-card outlined class="rounded-lg pa-2 pb-0 mb-32">
            ...
            <v-data-table
                ...
                :headers="[
                    ...
                    { text: 'Saved words', value: 'saved_words', align: 'center' },
                    { text: 'Saved limit', value: 'saved_words_limit', align: 'center' },
    ...
    export default {
        ...
        methods: {
            ...
            editUser(user) {
                ...
                this.editDialog.savedWordsLimit = user.saved_words_limit || 0;
            },
            closeUserDialog() {
